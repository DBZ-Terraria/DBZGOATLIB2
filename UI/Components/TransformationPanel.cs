...
{
    public class NodePanelComponent : DragableUIPanel
    {
        public NodePanelComponent(Asset<Texture2D> texture) : base(texture)
        {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            if (!dragging)
            {
                ...
                if (DBZConfig.Instance.TransMenuX != screenRatioPosition.X || DBZConfig.Instance.TransMenuY != screenRatioPosition.Y)
                {
                    ...
                    DBZGoatLib2.SaveConfig(DBZConfig.Instance);
                }
            }
        }
    }
